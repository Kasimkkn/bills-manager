        ...
        <TabsContent value="business" className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={businessProfile.type} onValueChange={(v) => setBusinessProfile({ ...businessProfile, type: v })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setBusinessProfile({ ...businessProfile, owner: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => setBusinessProfile({ ...businessProfile, gstRegistered: checked })}
                />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => handleSave("Bank Details")}>Save Bank Details</Button>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setInvoiceSettings({ ...invoiceSettings, defaultTax: v })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setInvoiceSettings({ ...invoiceSettings, paymentTerms: v })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setInvoiceSettings({ ...invoiceSettings, showBank: checked })}
                  />
                </div>
              </div>
              <Button onClick={() => handleSave("Invoice Settings")}>Save Settings</Button>
            </CardContent>
          </Card>
        </TabsContent>
