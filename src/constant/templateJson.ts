...
export const ECOMMERCE_VIBRANT: DynamicBillConfig = {
    ...
    billSummary: {
        ...
        sgst: 125.82,
        totalDue: 1649.64,
        totalInWords: "One Thousand Six Hundred Forty Nine Rupees and Sixty Four Paise Only",
...
export const SALON_LUXURY: DynamicBillConfig = {
    ...
    billSummary: {
        ...
        sgst: 259.2,
        totalDue: 3398.4,
        totalInWords: "Three Thousand Three Hundred Ninety Eight Rupees and Forty Paise Only",
        discountType: "PERCENTAGE",
    },
    isPaymentSectionNeeded: true,
    payment: {
...
/**
 * Get a template by bill type and style
 * @param billType - The type of bill (ECOMMERCE, HOTEL, etc.)
 * @param templateStyle - The style variant (VIBRANT, ELEGANT, etc.)
...
export function getTemplate(
    ...
    return ALL_TEMPLATES[billType]?.[templateStyle as keyof typeof ALL_TEMPLATES[typeof billType]];
}
 ...
 */
export function getAvailableStyles(billType: keyof typeof ALL_TEMPLATES): string[] {
