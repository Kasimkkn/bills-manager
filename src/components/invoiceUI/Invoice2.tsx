...
export default function Invoice2({ invoiceData }: { invoiceData: DynamicBillConfig }) {
                ...
                <div className="text-black">
                    ...
                    <div className="grid grid-cols-3 gap-12 mb-8 pb-6">
                        ...
                        {invoiceData.isBusinessInfoNeeded && invoiceData.businessInfo && (
                            <div>
                                <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">From</h2>
                                <div className="space-y-1.5 text-sm">
                                    ...
                                    {invoiceData.businessInfo.phoneNumber && (
                                        <div className="text-gray-600">{invoiceData.businessInfo.phoneNumber}</div>
                                    )}
                                </div>
                            </div>
                        )}
                            ...
                            <div>
                                ...
                                <div className="space-y-1.5 text-sm">
                                    ...
                                    {invoiceData.customerInfo.phone && (
                                        <div className="text-gray-600">{invoiceData.customerInfo.phone}</div>
                                    )}
                                </div>
                            </div>
                        )}
                    ...
                    <div className="grid grid-cols-2 gap-12 mb-8">
                        ...
                        <div>
                            {invoiceData.footer?.paymentTerms && (
                                <div className="mb-6">
                                    <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Payment Terms</h3>
                                    <p className="text-sm text-gray-700 leading-relaxed">{invoiceData.footer.paymentTerms}</p>
                                </div>
                            )}
                        </div>
                                ...
                                <div className="bg-gray-50 p-5 rounded-lg">
                                    <div className="space-y-3 text-sm">
                                        ...
                                        <div className="flex justify-between pt-3 border-t-2 border-gray-300 text-base font-bold text-gray-900">
                                            <span>Total</span>
                                            <span>${invoiceData.billSummary.totalDue.toFixed(2)}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {invoiceData.isPaymentSectionNeeded && invoiceData.payment && (
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3 text-sm">
                                    ...
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <div className="w-4 h-4 rounded-full border-2 border-gray-400 flex items-center justify-center">
                                            {invoiceData.payment.paymentOption === "BANK_TRANSFER" && (
                                                <div className="w-2 h-2 rounded-full bg-blue-600"></div>
                                            )}
                                        </div>
                            ...
                            {invoiceData.footer?.signature && (
                                <div className="inline-block">
                                    <div className="h-16 flex items-center justify-end mb-2">
                                        <svg width="120" height="50" viewBox="0 0 120 50" className="opacity-70">
                                            <path
                                    ...
                                    <div className="border-t-2 border-gray-900 pt-2 min-w-40">
                                        {invoiceData.footer.signature.split('\n').map((line, i) => (
                                            <div key={i} className="text-sm font-semibold text-gray-900">{line}</div>
                                        ))}
                                    </div>
                                </div>
                            )}
