            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-xl font-bold text-slate-800">BillWise</span>
                    </div>
                    ...
                    <div className='flex gap-2 items-center'>
                        ...
                        <Button
                            className="bg-gradient-to-r from-teal-500 to-sky-500 hover:from-teal-600 hover:to-sky-600 text-white text-sm md:text-base px-4 md:px-6"
                        >
