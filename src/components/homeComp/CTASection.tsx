                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-4">
                        <Button
                            ...
                            className="bg-background text-primary hover:bg-background/90 text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
                        >
                            Start Creating Free Invoices
                            <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
                        </Button>

                        <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-6 text-primary-foreground/90">
